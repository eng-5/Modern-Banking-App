...
<section id="product" className={layout.sectionReverse}>
    <div className={`${layout.sectionReverse} md:w-[50%]`}>
    ...
    <div className={layout.sectionInfo}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione sapiente placeat pariatur a iure earum nihil magni saepe consequatur? Officiis a in sed, quaerat facilis iusto quas facere saepe soluta?
      </p>
